...
async def dnsEnumerator4LLM(domain: str) -> dict:
    ...
    results = {
            "domain": domain,
            f"{domain}_dns_records": dns_records,
            f"{domain}_zone_transfers": zone_transfers,
            f"{domain}_spf_dmarc_analysis": spf_dmarc
        }
    return results
